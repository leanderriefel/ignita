  ...
  ),
  {
    variants: {
      variant: {
        ...
        outline: cn(
          "border border-border bg-background shadow-sm shadow-black/5 active:bg-secondary/50 dark:border-input dark:bg-input/30 dark:active:bg-secondary/40",
          Platform.select({
            web: "hover:bg-secondary/50 dark:hover:bg-secondary/40",
          }),
        ),
        secondary: cn(
        ...
        ghost: cn(
          "active:bg-secondary/50 dark:active:bg-secondary/40",
          Platform.select({
            web: "hover:bg-secondary/50 dark:hover:bg-secondary/40",
          }),
        ),
    ...
    variants: {
      variant: {
        ...
        outline: cn(
          ...
          Platform.select({ web: "group-hover:text-secondary-foreground" }),
        ),
        secondary: "text-secondary-foreground",
        ghost: "group-active:text-secondary-foreground",
        link: cn(
