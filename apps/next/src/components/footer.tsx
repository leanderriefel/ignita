...
export const Footer = () => {
  return (
    <div className="grid h-20 grid-cols-2 items-center border-y border-y-foreground bg-muted px-4 md:px-24">
      <p className="text-xs md:text-sm">© 2025 Leander Riefel</p>
