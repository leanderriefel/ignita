...
const createLatexWidget =
  ...
  () => {
    ...
    span.className = cn(span.className, {
      "hover:bg-secondary inline-block cursor-pointer rounded-[0.2rem] p-1 transition-colors":
        isEditable,
    })
    try {
...
const handleLaTeXMatch = (
  ...
  decorationsToAdd.push(
    Decoration.inline(
      ...
      matchEnd,
      {
        class: cn("bg-foreground text-background rounded-[0.2rem] p-1", {
          "absolute inline-block h-0 w-0 overflow-hidden opacity-0":
