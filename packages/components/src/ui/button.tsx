...
const buttonStyles = cva(
  "focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 rounded-full text-sm font-medium whitespace-nowrap transition-all outline-none focus-visible:ring-[3px] disabled:pointer-events-none disabled:cursor-default disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        primary:
          "bg-primary/30 border-primary text-primary-foreground hover:bg-primary/60 [&_svg]:fill-primary-foreground border shadow-xs",
        secondary:
          "bg-secondary/30 text-secondary-foreground hover:bg-secondary/60 border-secondary [&_svg]:fill-secondary-foreground border shadow-xs",
        destructive:
          "bg-destructive/30 border-destructive hover:bg-destructive/60 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60 [&_svg]:fill-destructive-foreground border text-white shadow-xs",
        outline:
